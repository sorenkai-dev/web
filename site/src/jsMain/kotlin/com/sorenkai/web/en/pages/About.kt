...
import com.sorenkai.web.en.content.AboutContentEn
import com.sorenkai.web.en.content.AboutHeroEnQuote
...
fun AboutPage() {
    ...
    Column(
       ...
       AboutHeroEnQuote(breakpoint)
       AboutContentEn(breakpoint)
