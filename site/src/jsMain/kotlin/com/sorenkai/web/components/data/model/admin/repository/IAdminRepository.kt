...
interface IAdminRepository {
    ...
    suspend fun setWritingStatus(slug: String, status: WritingsStatus): AdminOk

    suspend fun setWritingFeatured(slug: String, featured: Boolean): AdminOk

    suspend fun deleteWriting(slug: String): AdminOk
